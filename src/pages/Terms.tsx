...
export default function Terms() {
  return (
    <div style={{ padding: "24px 120px" }}>
      ...
      <p>Welcome to DiploDev!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Diplo Software and Consulting Ltd's Website, located at
        www.diplodev.com
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use DiploDev if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of cu. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing DiploDev, you agreed to use
        cookies in agreement with the Diplo Software and Consulting Ltd's
        Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Diplo Software and Consulting Ltd and/or its
        licensors own the intellectual property rights for all material on
        DiploDev. All intellectual property rights are reserved. You may access
        this from DiploDev for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from DiploDev</li>
        <li>Sell, rent or sub-license material from DiploDev</li>
        <li>Reproduce, duplicate or copy material from DiploDev</li>
        <li>Redistribute content from DiploDev</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Diplo
        Software and Consulting Ltd does not filter, edit, publish or review
        Comments prior to their presence on the website. Comments do not reflect
        the views and opinions of Diplo Software and Consulting Ltd,its agents
        ...
        laws, Diplo Software and Consulting Ltd shall not be liable for the
      ...
      <p>
        Diplo Software and Consulting Ltd reserves the right to monitor all
      ...
      <p>
        You hereby grant Diplo Software and Consulting Ltd a non-exclusive
      ...
      <p>
        ...
        the hyperlink compensates the absence of Diplo Software and Consulting
      ...
      <p>
        ...
        e-mail to Diplo Software and Consulting Ltd. Please include your name,
      ...
      <p>
        No use of Diplo Software and Consulting Ltd's logo or other artwork will
