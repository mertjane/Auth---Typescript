  ...
  return (
    <div style={{ padding: "24px 120px" }}>
      ...
      <p>
        ...
        <a href="https://www.diplodev.com">diplodev.com</a> website
        ...
        &#8220;you&#8221; or &#8220;your&#8221;) and Diplo Software and
        Consulting Ltd (&#8220;Diplo Software and Consulting Ltd&#8221;,
        ...
        you do not have such authority, or if you do not agree with the terms of
        this agreement, you must not accept this agreement and may not access
        and use the Website and Services. You should read this Policy so you can
      ...
      <p>
        ...
        and social networks&#8217; privacy policies. We will not collect or
        share any personally identifiable information from the user.
      </p>
      ...
      <p>
        ...
        <a href="https://www.internetcookies.com" target="blank">
          internetcookies.com
        </a>{" "}
